...
Las historias se guardan en `clinicalRecords`. Todo profesional activo de SIVE puede consultar y actualizar expedientes; solo `admin` puede eliminarlos. Ajusta esta política si cada área requiere aislamiento adicional.
